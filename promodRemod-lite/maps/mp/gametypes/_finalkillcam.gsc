...
addKillcamKiller(attacker,victim)
{
	...
	self.villain.glowColor = (255,0,0);
	self.villain moveOverTime( 4 );
	self.villain fadeOverTime( 2 );
	self.villain.x = -20;  
	...
	self.versus.glowColor = (0,228,255);
	...
	self.victim.glowColor = (0,255,0);
	self.victim moveOverTime( 4 );
	self.victim fadeOverTime( 2 );
	self.victim.x = 20;
