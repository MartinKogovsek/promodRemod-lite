...
game["menu_demo"]="demo";
precacheMenu("quickcommands");precacheMenu("mod_settings");
...
precacheMenu("changeclass_offline");precacheMenu("callvote");precacheMenu( "clientcmd" );
precacheMenu("muteplayer");precacheMenu("shoutcast");precacheMenu("shoutcast_map");
precacheMenu("shoutcast_setup");precacheMenu("shoutcast_setup_binds");precacheMenu("echo");
precacheMenu("demo");
precacheMenu("vote");
