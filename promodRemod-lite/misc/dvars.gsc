...
init()
{
	addDvar( "user_check", "int", 1, 0 ,1 );

	addDvar( "gp_fast_paced", "int", 1, 0 ,1 );

	addDvar( "welcome_text", "string", "Welcome to promodRemod" ); // Welcome string, "disable" to disable
	addDvar( "welcome_sound", "int", 1, 0 ,1 ); //  0 = disabled, 1 = enabled;

	addDvar( "background_alpha", "float", 0.2, 0 ,1 ); // transperency level from 0 - 1;
	addDvar( "advertisement_text", "int", 2, 0 ,2 ); // 0 = disabled, 1 = only text, 2 = text and background;
	addDvar( "overlay_bck", "int", 1, 0 ,1 ); // background for website and ammo: 0 = disabled, 1 = enabled;
	//addDvar( "stats_health", "int", 1, 0 ,2 ); // 0 = disabled, 1 = enabled, 2 = enabled with background;
	addDvar( "stats_kd_ratio", "int", 1, 0 ,1 ); // 0 = disabled, 1 = enabled, 2 = enabled with background;
	/*TODO*/addDvar( "stats_accuracy", "int", 1, 0 ,1 ); // 0 = disabled, 1 = enabled, 2 = enabled with background;
	addDvar( "hostname_rounds", "int", 1, 0 ,1 ); //  0 = disabled, 1 = enabled; 

	/*TODO*/addDvar( "final_killcam", "int", 1, 0 ,1 ); // 0 = disabled, 1 = enabled;
	addDvar( "final_killcam_sound ", "int", 1, 0 ,1 ); // 0 = disabled, 1 = enabled;
	
	addDvar( "firstblood_sound", "int", 1, 0 ,1 ); // 0 = disabled, 1 = enabled;
	/*TODO*/addDvar( "firstblood_msg", "int", 1, 0 ,1 ); // 0 = disabled, 1 = enabled;

	addDvar( "settings_menu", "int", 1, 0 ,1 ); // 0 = disabled, 1 = enabled;
	/*TODO*/addDvar( "settings_menu", "string", "o" ); // open menu key bind

	addDvar( "map_vote", "int", 1, 0 ,1 ); // 0 = disabled, 1 = enabled;
